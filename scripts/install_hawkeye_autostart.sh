...
echo "  • hawkeye-update.timer     — pull GitHub every 5 min + refresh UI/LLM"
...
echo "  ${SYSCTL[*]} list-timers hawkeye-update.timer"
echo "  ./scripts/hawkeye_self_update.sh --check"
echo
echo "Disable later:"
echo "  $0 ${MODE} --disable"
echo "  # or pause updates only:  HAWKEYE_UPDATE_ENABLED=0 in .env"
